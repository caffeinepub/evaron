...
import { Car, Sun, Factory } from 'lucide-react';
  ...
  const products = [
    {
      ...
      image: '/assets/generated/ev-battery.dim_400x300.png',
      icon: Car,
    },
    {
      ...
      image: '/assets/generated/solar-battery.dim_400x300.png',
      icon: Sun,
    },
    {
      title: 'Industrial Battery Pack',
      description: 'Heavy-duty battery packs for industrial applications requiring reliable power and long operational life.',
      image: '/assets/generated/industrial-battery.dim_400x300.png',
      icon: Factory,
    },
  ];
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="relative h-64 overflow-hidden bg-gray-100">
                ...
                />
                <div className="absolute top-4 right-4 w-12 h-12 bg-brand-orange flex items-center justify-center">
